...
@Feature("Logged in order completion - Dino user")
public class CompleteOrderAsDinoUserTest extends BaseTestConfig {
    ...
    @Description("Completing and order with Dino user selecting cash payment")
    public void completing_an_order_as_dino_user_with_cash_on_delivery_payment_option(Product product){
    ...
    @Test(dataProviderClass = ProductsDataProvider.class,dataProvider = "allProducts")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Completing and order with Dino user selecting credit card payment")
    public void completing_an_order_as_dino_user_with_credit_card_payment_option(Product product){
    ...
    @Test(dataProviderClass = ProductsDataProvider.class,dataProvider = "allProducts")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Completing and order with Dino user selecting paypal payment")
    public void completing_an_order_as_Dino_user_with_paypal_payment_option(Product product){
