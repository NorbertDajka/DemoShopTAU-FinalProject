...
@Feature("Logged in order completion - Beetle user")
public class CompleteOrderAsBeetleUserTest extends BaseTestConfig {
    DemoShopPage page;
    Header header;
    CartPage cartPage;
    ...
    @Description("Completing and order with Beetle user selecting cash payment")
    ...
    @Test(dataProviderClass = ProductsDataProvider.class,dataProvider = "allProducts")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Completing and order with Beetle user selecting credit card payment")
    ...
    @Test(dataProviderClass = ProductsDataProvider.class,dataProvider = "allProducts")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Completing and order with Beetle user selecting paypal payment")
